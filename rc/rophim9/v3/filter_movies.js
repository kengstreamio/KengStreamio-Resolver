...
// Story 10-13 | RoPhim9 | Filter Phim Lẻ — v3
...
//
// NOTE: No combined filter API available on the active provider origin for movie cards.
// Uses HTML search page (/tim-kiem).
//
...
async function filterMovies(baseUrl, 
    ...
    try {
        console.log('[KENG][RoPhim9] filterMovies: page ' + page);
        const url = buildUrl();
        ...
        console.log('[KENG][RoPhim9] filterMovies SUCCESS: ' + finalResults.length + ' items (page ' + page + ')');
        return JSON.stringify(finalResults);

    } catch (e) {
        console.log('[KENG][RoPhim9] filterMovies error: ' + e.message);
