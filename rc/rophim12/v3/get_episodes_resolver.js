...
async function getEpisodes(filmUrl) {
  ...
  try {
    console.log(`[KENG][RoPhim12] getEpisodes: ${filmUrl}`);
    ...
    console.log(`[KENG][RoPhim12] getEpisodes: returned ${episodes.length} episodes`);
    return JSON.stringify(episodes);

  } catch (e) {
    console.error(`[KENG][RoPhim12] getEpisodes ERROR: ${e.message}`);
