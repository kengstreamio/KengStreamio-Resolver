...
// Story 5-7a | Motchill | All Chinese (CTA — paged)
// Contract: getAllChinese(page = 1) → JSON array ([] khi hết trang)
// Target: /quoc-gia/trung-quoc?page=N on the active provider origin

async function getAllChinese(baseUrl, page = 1) {
