...
async function railGroupHot(baseUrl) {
  ...
  console.log('[KENG][RoPhim12] railGroupHot() v6 — Dedicated API');
  ...
  try {
    ...
    console.log('[KENG][RoPhim12] Dedicated Phim Hot rail loaded: ' + movies.length + ' movies');
    return JSON.stringify([rail]); // Plain array for rail groups in v6

  } catch (e) {
    console.error('[KENG][RoPhim12] railGroupHot() ERROR: ' + e.message);
