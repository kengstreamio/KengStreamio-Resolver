...
// Story 10-13 | RoPhim12 | Filter Phim Lẻ — v3
...
async function filterMovies(baseUrl, 
    ...
    try {
        console.log('[KENG][RoPhim12] filterMovies: page ' + page);
        const url = buildUrl();
        ...
        console.log('[KENG][RoPhim12] filterMovies SUCCESS: ' + finalResults.length + ' items (page ' + page + ')');
        return JSON.stringify(finalResults);

    } catch (e) {
        console.log('[KENG][RoPhim12] filterMovies error: ' + e.message);
