...
async function searchMovies(baseUrl, keyword, page = 1) {
  ...
  try {
    console.log(`[KENG][RoPhim12] searchMovies: "${keyword}" (page ${page})`);
    ...
    console.log(`[KENG][RoPhim12] searchMovies: returned ${movies.length} results`);
    return JSON.stringify(movies);

  } catch (e) {
    console.error(`[KENG][RoPhim12] searchMovies ERROR: ${e.message}`);
